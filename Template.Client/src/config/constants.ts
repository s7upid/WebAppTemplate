...
export const TEST_IDS = {
  ...
  ROLE_DESCRIPTION_INPUT: "role-description-input",
  ...
  NAV_LOGIN: "nav-login",
  NAV_ACCESS: "nav-access",
  NAV_USERS: "nav-users",
  NAV_ROLES: "nav-roles",
  CREATE_USER_BUTTON: "create-user-button",
  CREATE_ROLE_BUTTON: "create-role-button",
  BACK_TO_USERS_BUTTON: "back-to-users-button",
  BACK_TO_ROLES_BUTTON: "back-to-roles-button",
  ROLES_TABLE: "role-table",
  ROLE_SEARCH: "role-search",
  ROLE_OPTION: "role-option",
  SAVE_ROLE_BUTTON: "save-role-button",
  SAVE_PERMISSIONS_BUTTON: "save-permissions-button",
  APPROVE_USER_BUTTON: "approve-user-button",
  SYSTEM_ROLE_INDICATOR: "system-role-indicator",
